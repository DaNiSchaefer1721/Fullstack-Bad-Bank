                ...
                <Box m={2}>
                  <FormControl className="custom-input-box">
                    ...
                    <Select
                      ...
                      label="Avatar"
                    >
                      <MenuItem value="/images/Avatar0.png">Bad Piggy Bank</MenuItem>
                      <MenuItem value="/images/Avatar1.png">Little Helper</MenuItem>
                      <MenuItem value="/images/Avatar5.png">Rumba Cat</MenuItem>
                      <MenuItem value="/images/Avatar6.png">Little Helper 2</MenuItem>
                      <MenuItem value="/images/Avatar2.png">Hacker Dog</MenuItem>
                      <MenuItem value="/images/Avatar4.png">For the Love of Pets</MenuItem>
                      <MenuItem value="/images/Avatar3.png">AI the Robo-Cat</MenuItem>
                    </Select>
                  </FormControl>
                </Box>
                <Box m={2}>
